...
rcrop<-crop(r,e*1.1)
=======
r1<-raster("C:/Users/Ben/Dropbox/Droning/spectral.tif",band=1,values=T)
```
...
#save raster to file if we need to start from there

#rcrop<-brick(paste(droppath,"Droning/SpectralCrop.gri",sep="/"))
>>>>>>> ebe1d4083b13fe1c8e50719813ccda13010c96b8
plot(rcrop)
```
